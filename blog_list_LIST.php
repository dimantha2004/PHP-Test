...
class blog_list_LIST {
    ...
    public function search_from_heading($get_like_heading) {
        $this->sql_search_data = $this->sql_search_data . " and heading like '%" . $get_like_heading . "%'";
    }

    public function search_form_FIX_heading($get_heading) {
        $this->sql_search_data = $this->sql_search_data . " and heading='" . $get_heading . "'";
    }
    ...
    public function get_result() {
        ...
        $get_sql_query = "select ". $this->sql_process_data." from blog_list where ast='" . $this->ast . "'" . $this->sql_search_data. $this->pagination_data_result;
